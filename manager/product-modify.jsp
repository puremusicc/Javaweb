	...
	<div class="main">
		...
		<div class="manage">
			<form action="goods.do" METHOD="post" >
				<input type="hidden" name="mth" value="modify">
				<input type="hidden" name="gid" value="${goods.gid}">
				<table class="form">
					<tr>
						<td class="field">商品名称：</td>
						<td><input type="text" class="text" name="gname" value="${goods.gname}" /></td>
					</tr>
					<tr>
						...
						<td>
							<select name="tid">
								...
								<option value="${type.tid}" <c:if test="${type.tid==goods.tid.tid}">selected</c:if> >${type.tname}</option>
								</c:forEach>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="hidden" name="pic" value="${goods.pic}" id="pic">
							<img src="${pageContext.request.contextPath}/${goods.pic}" width="100px" id="img" height="100px"/>
						</td>
					</tr>
					<tr>
						<td class="field">商品价格：</td>
						<td><input type="text" class="text tiny" value="${goods.price}" name="price" /> 元</td>
					</tr>
					<tr>
						...
						<td>
							<select name="state">
								...
								<option value="0" <c:if test="${goods.state==0}">selected</c:if>>不上架</option>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" class="text" name="createDate" value="${goods.createDate}" readonly />
						</td>
					</tr>
					<tr>
						<td class="field">商品描述：</td>
						<td>
							<textarea name="context" cols="100" rows="8" style="width:500px;height:200px;visibility:hidden;">${goods.details}</textarea>
						</td>
					</tr>
					<tr>
						<td></td>
