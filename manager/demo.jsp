...
<body>
<%=htmlData %>
	<form name="example" method="post" action="demo.do"  >
		<textarea name="context" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br />
