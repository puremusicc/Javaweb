	...
	<div class="main">
		...
		<div class="manage">
			<form action="type.do" method="post">
				<input type="hidden" value="modify" name="mth"/>
				<table class="form">
					<tr>
						<td class="field">分类编号：</td>
						<td>
							<input type="text" name="tid" value="${type.tid}" readonly>
						</td>
					</tr>
					<tr>
						<td class="field">分类名称：</td>
						<td><input type="text" class="text" name="tname" value="${type.tname}" /></td>
					</tr>
					<tr>
						<td></td>
